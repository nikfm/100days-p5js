...
function Pair(x,y) {
  ...
  this.p2 = new Particle(x+random(-2,2),y+random(-2,2));
  ...
  djd.frequencyHz = 4;  // Try a value less than 5 (0 for no elasticity)
  djd.dampingRatio = 0.01; // Ranges between 0 and 1 (1 for no springiness)
